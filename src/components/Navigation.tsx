  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200">
      <div className="flex items-center justify-around h-14 max-w-screen-xl mx-auto px-1">
        ...
        <Link
          to="/"
          className={`flex flex-col items-center justify-center gap-0.5 min-w-[36px] ${
        ...
        <Link
          to="/food"
          className={`flex flex-col items-center justify-center gap-0.5 min-w-[36px] ${
            isActive("/food") ? "text-black" : "text-gray-500"
          }`}
        >
        ...
        <Dialog>
          <DialogTrigger asChild>
            <button className="flex items-center justify-center w-9 h-9 rounded-lg bg-black text-white hover:opacity-90 transition-opacity">
        ...
        <Link
          to="/community"
          className={`flex flex-col items-center justify-center gap-0.5 min-w-[36px] relative ${
