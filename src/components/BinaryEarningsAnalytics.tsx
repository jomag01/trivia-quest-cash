      ...
      <div className="space-y-6">
        <Card className="p-6 sm:p-8 bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-orange-500/10 border-purple-500/30">
          <div className="text-center space-y-4">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold mb-2">Join AI Beehives</h2>
              <p className="text-muted-foreground text-sm sm:text-base max-w-md mx-auto">
                You're not yet enrolled in the AI Beehives Program. Purchase an AI Package to unlock AI Beehives commissions and start earning!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 max-w-2xl mx-auto">
              ...
              <div className="p-4 bg-background/50 rounded-lg border">
                ...
                <h4 className="font-semibold text-sm">AI Beehives Earnings</h4>
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
        <Card className="p-3 sm:p-4 bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-green-500/20">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground">Total AI Beehives Earnings</p>
        </Card>
      ...
      <Card className="p-4 sm:p-6">
        <h3 className="font-bold mb-3 sm:mb-4 flex items-center gap-2 text-sm sm:text-base">
          ...
          Recent AI Beehives Commissions
        </h3>
        {earnings.length === 0 ? (
          <div className="text-center py-6 sm:py-8 text-muted-foreground">
            <GitBranch className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 opacity-50" />
            <p className="text-sm sm:text-base">No AI Beehives commissions yet</p>
